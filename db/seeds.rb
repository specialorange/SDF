...
# p chris.index
  ...
  songs10 = Song.create( title: 'song title 11', content: 'song content 11', user_id: teacher3.id )
  songs10 = Song.create( title: 'song title 12', content: 'song content 12', user_id: teacher3.id )
  songs10 = Song.create( title: 'song title 13', content: 'song content 13', user_id: student1.id )
  songs10 = Song.create( title: 'song title 14', content: 'song content 14', user_id: student2.id )
  songs10 = Song.create( title: 'song title 15', content: 'song content 15', user_id: student3.id )
  songs10 = Song.create( title: 'song title 16', content: 'song content 16', user_id: student4.id )
  songs10 = Song.create( title: 'song title 17', content: 'song content 17', user_id: student5.id )
  songs10 = Song.create( title: 'song title 18', content: 'song content 18', user_id: student6.id )
  songs10 = Song.create( title: 'song title 19', content: 'song content 19', user_id: student7.id )
  songs10 = Song.create( title: 'song title 20', content: 'song content 20', user_id: student8.id )
  songs10 = Song.create( title: 'song title 21', content: 'song content 21', user_id: student9.id )
  songs10 = Song.create( title: 'song title 22', content: 'song content 22', user_id: student10.id )
